jQuery(document).ready(function() {
    for (var t = document.getElementsByTagName("script"), e = "", a = 0; a < t.length; a++) t[a].src && t[a].src.match(/initslider-1\.js/i) && (e = t[a].src.substr(0, t[a].src.lastIndexOf("/") + 1));
    jQuery("#amazingslider-1").amazingslider({
        ...
        texteffect: "slide",
        lightboxthumbheight: 75,
        navspacing: 8,
        navarrowimage: "../img/navarrows-28-28-0.png",
        // ribbonimage: "../imgribbon_topleft-0.png",
        navwidth: 100,
        navheight: 75,
        arrowimage: "../img/arrows-36-80-0.png",
        timeropacity: .6,
        arrowhideonmouseleave: 1e3,
        navthumbnavigationarrowimage: "../img/arrows-36-80-0.png",
        ...
        navmarginy: 16,
        navmarginx: 16,
        navfeaturedarrowimage: "../img/featuredarrow-16-8-2.png",
        showribbon: !1,
        navstyle: "thumbnails",
        ...
        // navimage: "../img/bullet-24-24-1.png",
