...
const Productdetails = ({ state, libraries, actions }) => {
  ...
  /* const fetchData = async () => {
     ...
     // newprodstatus = result.releaseTimeDate.stock;   
     setNewprodstatus(result.releaseTimeDate.stock)
      //actions.postWithCategory.updatePostData(result);
      //setprodData(newprodstatus);
   };*/
  ...
  //const prodStatus = result.releaseTimeDate.stock;

  /*const prodStatus = newprodstatus;
  console.log("new prodStatus123======",prodStatus);*/
